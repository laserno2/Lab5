...
public class BlackJackController implements Initializable {
	...
	public void btnHit_Click(ActionEvent event) {
		...
		seqDeal.getChildren().addAll(patTMoveRot, patTFadeInFadeOut,scaleT);
	...
	private PathTransition CreatePathTransition(Point2D fromPoint, Point2D toPoint, ImageView img) {
		...
		path.getElements().add(new CubicCurveTo(toPoint.getX() * 2/3, toPoint.getY() * 2/3, toPoint.getX() / 3,
				toPoint.getY() / 3, toPoint.getX()+33, toPoint.getY()+47));
